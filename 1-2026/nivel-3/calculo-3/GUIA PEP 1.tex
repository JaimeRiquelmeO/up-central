%======================================================================
% USACH PREMIUM — Guía Cálculo III (Multivariable)
% Contenidos: Derivada direccional, crecimiento máximo, tasa de cambio,
% regla de la cadena, plano tangente, TFI, TFInv.
% Formato inspirado en plantilla institucional (ESTILOS.md).
%======================================================================
...
\newcommand{\listacontenidos}{
  ...
  \item[\color{azulFuerte}$\Rightarrow$] Dirección de crecimiento máximo (gradiente)
  \item[\color{azulFuerte}$\Rightarrow$] Tasa de cambio a lo largo de trayectorias
  \item[\color{azulFuerte}$\Rightarrow$] Regla de la cadena (multivariable)
  \item[\color{azulFuerte}$\Rightarrow$] Plano tangente y linealización
  \item[\color{azulFuerte}$\Rightarrow$] Teorema de la función implícita (TFI)
  \item[\color{azulFuerte}$\Rightarrow$] Teorema de la función inversa (TFInv)
}
...
\begin{center}
    \color{azulFuerte}
    {\huge \textbf{Guía Preparación PEP 1}} \\[0.5cm]
...
--------------------------------------------------------
% =========================================================================
% TEMA 1: LÍMITES, CONTINUIDAD Y DIFERENCIABILIDAD (10 EJERCICIOS)
% =========================================================================
\section{Límites, Continuidad y Diferenciabilidad en $\mathbb{R}^n$}

% --- EJERCICIO 1 ---
\begin{ejercicios}{Ejercicio 1.1: Límites por Trayectorias Parabólicas}
...
% --- EJERCICIO 1.2 ---
\begin{ejercicios}{Ejercicio 1.2: Coordenadas Polares y Acotamiento}
...
% --- EJERCICIO 1.3 ---
\begin{ejercicios}{Ejercicio 1.3: Continuidad por Tramos}
...
% --- EJERCICIO 1.4 ---
\begin{ejercicios}{Ejercicio 1.4: Diferenciabilidad y Definición Estricta}
...
\begin{solbox}{Solución Ejercicio 1.4}
    ...
    \[ \frac{\partial f}{\partial x}(0,0) = \lim_{h \to 0} \frac{\sqrt[3]{h^2}-0}{h} = 1, \quad \frac{\partial f}{\partial y}(0,0) = 1 \]
...
% --- EJERCICIO 1.5 ---
\begin{ejercicios}{Ejercicio 1.5: Teorema del Sándwich Complejo}
...
% --- EJERCICIO 1.6 ---
\begin{ejercicios}{Ejercicio 1.6: Continuidad de Funciones Racionales}
...
% --- EJERCICIO 1.7 ---
\begin{ejercicios}{Ejercicio 1.7: Diferenciabilidad con Parciales Continuas}
...
% --- EJERCICIO 1.8 ---
\begin{ejercicios}{Ejercicio 1.8: Límites con Exponenciales}
...
% --- EJERCICIO 1.9 ---
\begin{ejercicios}{Ejercicio 1.9: Trayectorias Cúbicas}
...
% --- EJERCICIO 1.10 ---
\begin{ejercicios}{Ejercicio 1.10: Demostración formal $\epsilon-\delta$}
...
% --- EJERCICIO 2.1 ---
\begin{ejercicios}{Ejercicio 2.1: Distribución Térmica en Placas}
...
\begin{solbox}{Solución Ejercicio 2.1}
    ...
    La tasa de cambio máxima de disminución es la magnitud del gradiente: $\|\nabla T(1,2)\| = \sqrt{(-6)^2+(-8)^2} = 10$.
\end{solbox}

\vspace{3mm}

% --- EJERCICIO 2.2 ---
\begin{ejercicios}{Ejercicio 2.2: Potencial Eléctrico Tridimensional}
...
% --- EJERCICIO 2.3 ---
\begin{ejercicios}{Ejercicio 2.3: Trayectoria de Máxima Pendiente (Topografía)}
...
% --- EJERCICIO 2.4 ---
\begin{ejercicios}{Ejercicio 2.4: Propiedad Algebraica del Gradiente}
...
% --- EJERCICIO 2.5 ---
\begin{ejercicios}{Ejercicio 2.5: Dirección Ortogonal y Cambio Nulo}
...
% --- EJERCICIO 2.6 ---
\begin{ejercicios}{Ejercicio 2.6: Tasa en Superficies Cuádricas}
...
\begin{solbox}{Solución Ejercicio 2.6}
    ...
    Queremos maximizar el cambio en la componente $z$, la cual está controlada directamente por la coordenada de la superficie. Analizando el gradiente sobre la restricción del radio unitario, el máximo valor de cambio absoluto ocurre en el extremo geométrico superior donde las pendientes se alinean con el eje coordenado, esto es, en el punto $P(0,0,1)$.
\end{solbox}

\vspace{3mm}

% --- EJERCICIO 2.7 ---
\begin{ejercicios}{Ejercicio 2.7: Máxima Variación Inversa}
...
% --- EJERCICIO 2.8 ---
\begin{ejercicios}{Ejercicio 2.8: Campo Escalar Combinado}
...
% --- EJERCICIO 2.9 ---
\begin{ejercicios}{Ejercicio 2.9: Aplicación Física de Flujo}
...
% --- EJERCICIO 2.10 ---
\begin{ejercicios}{Ejercicio 2.10: Deducción Geométrica de la Tasa}
...
% --- EJERCICIO 3.1 ---
\begin{ejercicios}{Ejercicio 3.1: Derivada Direccional Clásica}
...
% --- EJERCICIO 3.2 ---
\begin{ejercicios}{Ejercicio 3.2: Uso Obligatorio de la Definición por Límite}
...
% --- EJERCICIO 3.3 ---
\begin{ejercicios}{Ejercicio 3.3: Dirección con Ángulo Especial}
...
% --- EJERCICIO 3.4 ---
\begin{ejercicios}{Ejercicio 3.4: Espacio Tridimensional}
...
% --- EJERCICIO 3.5 ---
\begin{ejercicios}{Ejercicio 3.5: Ecuaciones Simultáneas con Derivadas}
...
% --- EJERCICIO 3.6 ---
\begin{ejercicios}{Ejercicio 3.6: Derivada Direccional de Funciones Compuestas}
...
% --- EJERCICIO 3.7 ---
\begin{ejercicios}{Ejercicio 3.7: Derivada Direccional Nula en Logaritmos}
...
% --- EJERCICIO 3.8 ---
\begin{ejercicios}{Ejercicio 3.8: Función Exponencial Compleja}
...
% --- EJERCICIO 3.9 ---
\begin{ejercicios}{Ejercicio 3.9: Interpretación Geométrica Directa}
...
% --- EJERCICIO 3.10 ---
\begin{ejercicios}{Ejercicio 3.10: Variación Máxima Combinada}
...
% --- EJERCICIO 4.1 ---
\begin{ejercicios}{Ejercicio 4.1: Plano Tangente a Superficie Explícita}
...
% --- EJERCICIO 4.2 ---
\begin{ejercicios}{Ejercicio 4.2: Superficie Implícita Compleja}
...
% --- EJERCICIO 4.3 ---
\begin{ejercicios}{Ejercicio 4.3: Plano Tangente Horizontal}
...
% --- EJERCICIO 4.4 ---
\begin{ejercicios}{Ejercicio 4.4: Recta Tangente a la Curva de Intersección}
...
% --- EJERCICIO 4.5 ---
\begin{ejercicios}{Ejercicio 4.5: Planos Tangentes Paralelos}
...
% --- EJERCICIO 4.6 ---
\begin{ejercicios}{Ejercicio 4.6: Plano Tangente a partir de Datos Gráficos}
...
% --- EJERCICIO 4.7 ---
\begin{ejercicios}{Ejercicio 4.7: Demostración del Cono}
...
% --- EJERCICIO 4.8 ---
\begin{ejercicios}{Ejercicio 4.8: Ángulo entre Superficies}
...
\begin{solbox}{Solución Ejercicio 4.8}
    El ángulo entre dos superficies se define como el ángulo formado por sus respectivos vectores normales en el punto de intersección:
    \[ F_1(x,y,z) = x^2+y^2+z^2-9 \implies \nabla F_1(2,0,1) = (4, 0, 2) \]
    \[ F_2(x,y,z) = x^2+y^2-z-3 \implies \nabla F_2(2,0,1) = (4, 0, -1) \]
    Calculamos el coseno del ángulo utilizando el producto escalar analítico:
    \[ \cos(\theta) = \frac{|\nabla F_1 \cdot \nabla F_2|}{\|\nabla F_1\| \|\nabla F_2\|} = \frac{|4(4) + 0(0) + 2(-1)|}{\sqrt{16+0+4}\sqrt{16+0+1}} = \frac{|16 - 2|}{\sqrt{20}\sqrt{17}} = \frac{14}{\sqrt{340}} \]
    Por lo tanto, el ángulo exacto de intersección es $\theta = \arccos\left(\frac{14}{\sqrt{340}}\right)$.
\end{solbox}

\vspace{3mm}

% --- EJERCICIO 4.9 ---
\begin{ejercicios}{Ejercicio 4.9: Recta Tangente a una Curva Paramétrica}
...
% --- EJERCICIO 4.10 ---
\begin{ejercicios}{Ejercicio 4.10: Aproximación Lineal Mediante Plano Tangente}
...
% --- EJERCICIO 5.1 ---
\begin{ejercicios}{Ejercicio 5.1: Regla de la Cadena Estándar}
...
% --- EJERCICIO 5.2 ---
\begin{ejercicios}{Ejercicio 5.2: Variables Intermedias Múltiples}
...
% --- EJERCICIO 5.3 ---
\begin{ejercicios}{Ejercicio 5.3: Derivación de una Función Desconocida}
...
% --- EJERCICIO 5.4 ---
\begin{ejercicios}{Ejercicio 5.4: Derivada de Segundo Orden}
...
\end{ejercicios}
\begin{solbox}{Solución Ejercicio 4.4 / 5.4}
...
% --- EJERCICIO 5.5 ---
\begin{ejercicios}{Ejercicio 5.5: Aplicación en Termodinámica}
...
% --- EJERCICIO 5.6 ---
\begin{ejercicios}{Ejercicio 5.6: Cambios de Variable Simétricos}
...
% --- EJERCICIO 5.7 ---
\begin{ejercicios}{Ejercicio 5.7: Matriz Jacobiana de Composición}
...
% --- EJERCICIO 5.8 ---
\begin{ejercicios}{Ejercicio 5.8: Derivada en una Trayectoria Cúbica}
...
% --- EJERCICIO 5.9 ---
\begin{ejercicios}{Ejercicio 5.9: Identidad de Euler para Funciones Homogéneas}
...
% --- EJERCICIO 5.10 ---
\begin{ejercicios}{Ejercicio 5.10: Composición con Funciones Trigonométricas}
...
% --- EJERCICIO 6.1 ---
\begin{ejercicios}{Ejercicio 6.1: Verificación de Existencia y Derivación}
...
% --- EJERCICIO 6.2 ---
\begin{ejercicios}{Ejercicio 6.2: Plano Tangente mediante Derivación Implícita}
...
% --- EJERCICIO 6.3 ---
\begin{ejercicios}{Ejercicio 6.3: Derivada de Segundo Orden Implícita}
...
% --- EJERCICIO 6.4 ---
\begin{ejercicios}{Ejercicio 6.4: Sistema de Funciones Implícitas}
...
\begin{solbox}{Solución Ejercicio 6.4}
    ...
    \textbf{Corrección y Análisis Crítico institucional:} Dado que el determinante jacobiano es exactamente igual a 0 en dicho punto, \textbf{no se puede garantizar la existencia} de tales funciones mediante el Teorema de la Función Implícita clásico. El sistema no cumple la condición de regularidad en ese punto específico.
\end{solbox}

\vspace{3mm}

% --- EJERCICIO 6.5 ---
\begin{ejercicios}{Ejercicio 6.5: Derivación en un Sistema Válido}
...
% --- EJERCICIO 6.6 ---
\begin{ejercicios}{Ejercicio 6.6: Ecuación Trigonométrica Compleja}
...
\begin{solbox}{Solución Ejercicio 6.6}
    ...
    Aplicando la fórmula del teorema de la función implícita:
...
% --- EJERCICIO 6.7 ---
\begin{ejercicios}{Ejercicio 6.7: Relación de Tres Variables}
...
% --- EJERCICIO 6.8 ---
\begin{ejercicios}{Ejercicio 6.8: Superficie Exponencial}
...
% --- EJERCICIO 6.9 ---
\begin{ejercicios}{Ejercicio 6.9: Intersección y Linealidad}
...
% --- EJERCICIO 6.10 ---
\begin{ejercicios}{Ejercicio 6.10: Función Implícita de Argumento Compuesto}
...
% --- EJERCICIO 7.1 ---
\begin{ejercicios}{Ejercicio 7.1: Invertibilidad Local y Jacobiano}
...
% --- EJERCICIO 7.2 ---
\begin{ejercicios}{Ejercicio 7.2: Derivada de la Inversa en un Punto}
...
% --- EJERCICIO 7.3 ---
\begin{ejercicios}{Ejercicio 7.3: Transformación Polar}
...
% --- EJERCICIO 7.4 ---
\begin{ejercicios}{Ejercicio 7.4: Invertibilidad Local de Campo Exponencial}
...
% --- EJERCICIO 7.5 ---
\begin{ejercicios}{Ejercicio 7.5: Invertibilidad en Tres Dimensiones}
...
% --- EJERCICIO 7.6 ---
\begin{ejercicios}{Ejercicio 7.6: Relación Lineal Inversa}
...
% --- EJERCICIO 7.7 ---
\begin{ejercicios}{Ejercicio 7.7: Puntos Singulares de una Transformación}
...
% --- EJERCICIO 7.8 ---
\begin{ejercicios}{Ejercicio 7.8: Invertibilidad con Funciones Trigonométricas}
...
\begin{solbox}{Solución Ejercicio 7.8}
    ...
    Calculamos el determinante de la matriz resultante: $\det = 1(0) - 0(1) = 0$. \\
    Dado que el determinante es cero, el teorema \textbf{no garantiza la invertibilidad local} en el origen.
\end{solbox}

\vspace{3mm}

% --- EJERCICIO 7.9 ---
\begin{ejercicios}{Ejercicio 7.9: Jacobiano de una Composición Inversa}
...
% --- EJERCICIO 7.10 ---
\begin{ejercicios}{Ejercicio 7.10: Transformación Cúbica Pura}
...
\begin{solbox}{Solución Ejercicio 9.3}
    ...
    A partir de estos valores se obtienen las coordenadas exactas de $y$ y posteriormente $z$ utilizando la primera restricción lineal para encontrar el punto máximo buscado.
\end{solbox}
...
\begin{solbox}{Solución Ejercicio 9.6}
    El presupuesto genérico es $2x + 5y = I$. Del ejercicio 9.2 sabemos que la proporción de consumo ideal es $x = 0.25I / 2 = I/8$ e $y = 0.5I / 5 = I/10$.
    Sustituyendo estas demandas óptimas en la función de utilidad indirecta:
    \[ U^*(I) = \left(\frac{I}{8}\right)^{0.5} \left(\frac{I}{10}\right)^{0.5} = \frac{I}{\sqrt{80}} \]
    Derivando la utilidad máxima con respecto al parámetro presupuestario $I$:
    \[ \frac{\partial U^*}{\partial I} = \frac{1}{\sqrt{80}} \]
    Por otra parte, si evaluamos el valor de $\lambda$ en las ecuaciones originales usando los puntos óptimos, se comprueba la igualdad numérica exacta $\lambda = \frac{1}{\sqrt{80}}$, validando la propiedad de la variable sombra.
\end{solbox}
...
\begin{solbox}{Solución Ejercicio 10.1}
    ...
    \begin{itemize}
        ...
        Si $\mu = 1/2 \implies x = y$. Sustituyendo en la frontera: $2x^2 = 2 \implies x^2 = 1 \implies x = 1, y = 1$. El valor de la función objetivo en este punto óptimo es $f(1,1) = 1$.
    \end{itemize}
    Comparando los resultados de ambos casos, confirmamos que el máximo global sujeto a la desigualdad se encuentra en el punto $P(1,1)$ con un valor óptimo de $1$.
\end{solbox}
